        ...
        public AcceptThread() {
            ...
            try {
                ...
                tmp = bluetoothAdapter.listenUsingInsecureRfcommWithServiceRecord(
                        "MDP34",
                        MY_UUID);
                Log.e(TAG, "Socket's listen() method success" + MY_UUID);
            } catch (IOException e) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                bTSocket = bTDevice.createInsecureRfcommSocketToServiceRecord(uuidDevice);
            } catch (IOException e) {
                Log.e(TAG, "Socket's create() method failed", e);
            }
            bluetoothSocket = bTSocket;
            Log.d(TAG, "I am in Btsocket================="+bluetoothSocket);
            ...
            try {
                ...
                Log.d(TAG, "I am in connected Thread socket conect=================");
                // The connection attempt succeeded. Perform work associated with
                // the connection in a separate thread.
                connectedSocket(bluetoothSocket, bTDevice);
            } catch (IOException connectException) {
                // Unable to connect; close the socket and return.
                Log.e(TAG,"I am figuring out why cant connect",connectException);
                try {
                ...
                try {
                    BluetoothFragment bluetoothActivity = (BluetoothFragment) context;
...
//    public void activateServerThread () {
//        acceptThread = new AcceptThread();
//        acceptThread.start();
//    }
    ...
    public void activateClientThread(BluetoothDevice bTDevice, UUID uuid) {
        ...
        connectThread.start();
        Log.d(TAG, "I am in connected Thread =================");
    }
...
//        private byte[] buffer; // mmBuffer store for the stream
        ...
        public void write(byte[] bytes) {
            ...
            Log.d("", "Write: Writing to output stream: " + text);
            try {
